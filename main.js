...
;// CONCATENATED MODULE: ./src/js/shortSubject.js
...
const app_observable = interval(5000);
function fetchMessages() {
  return ajax.getJSON(url).pipe(catchError(error => {
...
app_observable.pipe(concatMap(() => fetchMessages()),
// выполняет запрос каждые 5 секунд последовательно
